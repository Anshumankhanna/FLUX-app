...
function SignUp({ onSignUp, onNavigateLogin }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-primary relative overflow-hidden">
      ...
      <div className="bg-[rgba(255,255,255,0.92)] backdrop-blur-[24px] border border-border-primary rounded-xl p-[48px_44px] w-[460px] max-w-[90vw] text-center animate-scale-in shadow-[0_8px_40px_rgba(0,0,0,0.08)]">
        <div className="flex items-center justify-center gap-[11px] mb-[32px]">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="42" height="42" style={{ borderRadius: 10, flexShrink: 0 }}>
            <rect width="40" height="40" rx="10" fill="url(#signupLogoGrad)" />
            <defs>
              <linearGradient id="signupLogoGrad" x1="0" y1="1" x2="1" y2="0">
        ...
        <h1 className="text-[26px] font-bold font-heading mb-[8px] text-text-primary">Create Account</h1>
        <p className="text-text-dim text-[13px] mb-[36px]">CFO Financial Intelligence Platform</p>

        {error && <p className="bg-[rgba(240,68,56,0.08)] border border-[rgba(240,68,56,0.25)] text-negative rounded-sm p-[10px_14px] text-[12px] mb-[18px] text-left">{error}</p>}

        <form onSubmit={handleSubmit}>
          <div className="mb-[20px] text-left">
            <label htmlFor="signup-name" className="block text-[11px] text-text-dim tracking-[0.5px] mb-[8px] font-medium">Full Name</label>
            <input
              id="signup-name"
              type="text"
          ...
          <div className="mb-[20px] text-left">
            <label htmlFor="signup-email" className="block text-[11px] text-text-dim tracking-[0.5px] mb-[8px] font-medium">Work Email</label>
            <input
              id="signup-email"
              type="email"
          ...
          <div className="mb-[20px] text-left">
            <label htmlFor="signup-password" className="block text-[11px] text-text-dim tracking-[0.5px] mb-[8px] font-medium">Password</label>
            <input
              id="signup-password"
              type="password"
          ...
          <div className="mb-[20px] text-left">
            <label htmlFor="signup-confirm" className="block text-[11px] text-text-dim tracking-[0.5px] mb-[8px] font-medium">Confirm Password</label>
            <input
              id="signup-confirm"
              type="password"
        ...
        <p className="mt-[24px] text-[12px] text-text-muted">
          ...
          <button className="bg-transparent border-none text-accent-purple-light font-semibold cursor-pointer outline-none transition-normal hover:text-accent-purple hover:underline p-0" onClick={onNavigateLogin}>
            Sign In
          </button>
        </p>
